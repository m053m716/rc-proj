...
%        m0 = jPCA.reshapeSkew_orth(M0k);
m0 = jPCA.reshapeSkew_orth(M0,false); % override check for skew matrix - MM
% m0 = jPCA.reshapeSkew_orth(m0);
...
[m, fM, i] = jPCA.minimize( m0 , 'jPCA.skewSymLSeval_orth' , 100000, dX , X );
% Aeq = [0ones();
...
% m = fmincon(@(m,dX,X)jPCA.skewSymLSeval_orth(m,dX,X),m0,A,b,Aeq,beq);
