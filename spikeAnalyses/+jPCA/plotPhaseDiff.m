...
circMn = jPCA.CircStat2010d.circ_mean([phaseData.phaseDiff]', [phaseData.radius]');
resultantVect = jPCA.CircStat2010d.circ_r([phaseData.phaseDiff]', [phaseData.radius]');
stats = jPCA.CircStat2010d.circ_stats([phaseData.phaseDiff]',[phaseData.radius]');
...
% w_avgDP = jPCA.averageDotProduct([phaseData.phaseDiff]',pi/2,[phaseData.radius]');
