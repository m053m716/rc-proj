...
%
%  fig = analyze.fails.view_scores(P);
%
%  -- Inputs --
%  P : Table from `[P,C] = analyze.fails.pca_table(U);`
...
fig(1) = figure('Name','Unsuccessful Grasp PC Scores',...
   'NumberTitle','off',...
   'Color','w',...
   'Units','Normalized',...
...
fig(2) = figure(...
   'Name','Unsuccessful Grasp: Zoom-In',...
   'NumberTitle','off',...
   'Color','w',...
   'Units','Normalized',...
...
fig(3) = figure(...
   'Name','Unsuccessful Grasp: Day Trajectories',...
   'NumberTitle','off',...
   'Color','w',...
   'Units','Normalized',...
...
suptitle('Unsuccessful Grasps');

% % Plot scores(:,[2,3]) trajectories by area & day for animals % %
fig(4) = figure(...
   'Name','Unsuccessful Grasp: By Area and Day',...
   'NumberTitle','off',...
   'Color','w',...
   'Units','Normalized',...
...
fig(5) = figure(...
   'Name','Unsuccessful Grasp: Gauss + Mod by Day',...
   'NumberTitle','off',...
   'Color','w',...
   'Units','Normalized',...
   'Position',[0.1 0.1 0.8 0.8]);
