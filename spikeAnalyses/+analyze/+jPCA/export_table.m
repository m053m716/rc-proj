...
pars = struct('align',"Grasp",'area',"All");
   ...
   for ii = 1:nTotal
      ...
      for iG = 1:2
         ...
         [Y{iG},stat] = splitapply(...
            @(x,y,a)analyze.stat.addLogisticRegression(ax2(ii),x,y,col(iG,:),...
               xPlot,'addlabel',false,'DisplayName',string(a(1))),...
            eThis.PostOpDay,...
            eThis.(responseVars{ii,1}),...
            eThis.AnimalID,...
            gThis);
         ...
         analyze.stat.addLogisticRegression(ax2(ii),...
