...
%
% Inputs
%  x - Vector or matrix to be re-indexed to alternate form during
...
% this reshapes a n(n-1)/2 vector to a n by n skew symmetric matrix;
% or vice versa, depending on the shape of the input data `x`
