...
rSub = outerjoin(rSub,Data.pre.pred,...
   'Keys',{'AnimalID','PostOpDay','Area','Outcome'},...
   'MergeKeys',true,...
   'Type','Left',...
   'LeftVariables',setdiff(rSub.Properties.VariableNames,{'N_Pre_Hat','N_Total','N_Channels','N_Trials','Duration_res'}),...
   'RightVariables',{'N_Pre_Hat','N_Total','N_Channels','N_Trials','Duration_res'});
rSub = outerjoin(rSub,Data.reach.pred,...
   'Keys',{'AnimalID','PostOpDay','Area','Outcome'},...
   'MergeKeys',true,...
   'Type','Left',...
   'LeftVariables',setdiff(rSub.Properties.VariableNames,{'N_Reach_Hat','Reach_Epoch_Duration_res'}),...
   'RightVariables',{'N_Reach_Hat','Reach_Epoch_Duration_res'});
rSub = outerjoin(rSub,Data.retract.pred,...
   'Keys',{'AnimalID','PostOpDay','Area','Outcome'},...
   'MergeKeys',true,...
   'Type','Left',...
   'LeftVariables',setdiff(rSub.Properties.VariableNames,{'N_Retract_Hat','Retract_Epoch_Duration_res'}),...
   'RightVariables',{'N_Retract_Hat','Retract_Epoch_Duration_res'});
...
rSub.epsilon_pre = pi.*(0.5 - rSub.delta_Pre_Tilde.^2 ./ (rSub.delta_Pre_Tilde.^2 + rSub.delta_Pre_Hat.^2));
rSub.epsilon_reach = pi.*(0.5 - rSub.delta_Reach_Tilde.^2 ./ (rSub.delta_Reach_Tilde.^2 + rSub.delta_Reach_Hat.^2));
rSub.epsilon_retract = pi.*(0.5 - rSub.delta_Retract_Tilde.^2 ./ (rSub.delta_Retract_Tilde.^2 + rSub.delta_Retract_Hat.^2));
