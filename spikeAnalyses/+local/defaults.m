...
pars = struct;
pars.LocalMatlabUtilitiesRepos = 'Utilities';
...
% Note: 40 (60-ms windows) is used for most-recent (2020) analyses
pars.N_DS_EDGES = 40; % 60-ms windows (updated times; uses new bin sizes)
pars.TableTimesFile = 'S:\Data\All Times.xlsx';
pars.TableauFolder = 'S:\Data';
