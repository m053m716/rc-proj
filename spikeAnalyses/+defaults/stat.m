...
p.modelspec = [...
   string([...
      'EnvelopeBW~'                          ... % Response 
      'GroupID*Area*PostOpDay+'              ... % Fixed effect of Group*Area interaction
      '(-1+Duration*PostOpDay|GroupID:Area)' ... % Random: Slope of PostOpDay(Area nested in Group) 
   ]); ...
   string([...
      'PeakOffset~'                       ... % Response 
      'GroupID*Area+'                     ... 
      '(-1+Duration|GroupID)+'            ... 
      '(-1+Duration|Area)+'               ... 
      '(-1+Duration|GroupID:Area:PostOpDay)'           ... 
   ]);
   string([...
      'Z~'                                   ... % Response 
      'GroupID*Area*PostOpDay+'                             ... 
      '(-1+Duration*PostOpDay|GroupID:Area)'                ... 
   ])...
];
