...
jpca_params.planStateEvent = 'tGrasp'; % Should be 'tReach' or 'tGrasp' or 'tComplete'
...
movie_params.highlight_trial = [];
movie_params.highlight_offset = 150;
movie_params.htmp = [];
...
movie_params.projField = 'proj'; % Field to plot from Projection structure
movie_params.projType = 'skew';  % 'skew' | 'best'
movie_params.rankType = 'eig';
...
rosette_params.XLim = [-5 5];
rosette_params.XColor = 'k';
rosette_params.YLim = [-5 5];
